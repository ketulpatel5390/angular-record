...
@Component({
  selector: 'app-album-library-song-card',
  templateUrl: './album-library-song-card.component.html',
  styleUrls: ['./album-library-song-card.component.css']
})
export class AlbumLibrarySongCardComponent implements OnInit, OnDestroy,AfterViewInit {
...
let self = this;
  ...
  onQueueHandler(song){
    ...
    let data:any={'SongId':song.SongId,'Event':MusicEventActions.Queue,'songdata':song,'artistimage':artistimage,'inLibrary':self.inLibrary};
