...
@Component({
  selector: 'app-admin-album-song-card',
  templateUrl: './admin-album-song-card.component.html',
  styleUrls: ['./admin-album-song-card.component.css']
})
export class AdminAlbumSongCardComponent implements OnInit, OnDestroy {
