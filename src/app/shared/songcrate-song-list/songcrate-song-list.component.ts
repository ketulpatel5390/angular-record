...
@Component({
  selector: 'app-songcrate-song-list',
  templateUrl: './songcrate-song-list.component.html',
  styleUrls: ['./songcrate-song-list.component.css']
})
export class SongcrateSongListComponent implements OnInit, OnDestroy {
