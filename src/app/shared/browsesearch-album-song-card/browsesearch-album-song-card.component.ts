...
@Component({
  selector: 'app-browsesearch-album-song-card',
  templateUrl: './browsesearch-album-song-card.component.html',
  styleUrls: ['./browsesearch-album-song-card.component.css']
})
export class BrowsesearchalbumSongCardComponent implements OnInit, OnDestroy,AfterViewInit {
