...
@Component({
  selector: 'app-list-application-card',
  templateUrl: './list-application-card.component.html',
  styleUrls: ['./list-application-card.component.css']
})
export class ListApplicationCardComponent implements OnInit {
