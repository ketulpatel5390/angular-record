...
@Component({
  selector: 'app-songcrate-song-card',
  templateUrl: './songcrate-song-card.component.html',
  styleUrls: ['./songcrate-song-card.component.css']
})
export class SongcrateSongCardComponent implements OnInit, OnDestroy {
