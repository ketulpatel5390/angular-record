...
import {IMyDpOptions,IMyDefaultMonth,IMyDateModel,IMyInputFieldChanged,IMyInputFocusBlur} from 'mydatepicker';
      ...
      if (response.status == 0 || response.status == null) {
        ...
        {  
          ...
          this.registrationform.reset({ 
            facebookid: '',firstName: '',lastName: '',dob: '',email: '',username: '',password: '',confirmPassword: '',
            country: '',state: '',city: '',songReviewLimit: '',genre: '',package: ''});*/
          swal({
